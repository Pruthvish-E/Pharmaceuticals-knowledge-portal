	...
	<header>
		...
		<div class="container">
			...
			<ul class="main-menu" id="main-menu">
				...
				<li><a href="stock_index.php">STOCK CHECK</a></li>
				<li><a href="producer_stock_insert.php">ADD NEW STOCK</a></li>
				<li><a href="feedback_index.php">CHECK FEEDBACKS</a></li>
				<li><a href="producer_loss_index.php">CHECK LOSS</a></li> 
				<li><a href="https://themillenialprint.run.goorm.io/home1">RESEARCH</a></li> 
